...
(custom-theme-set-faces
 ...
 '(fixed-pitch ((t (nil))))
 '(font-latex-string-face ((t (:bold t :weight semi-bold :foreground "lightslateblue" :background "black"))))
 ...
 '(font-lock-doc-face ((t (:bold t :background "black" :foreground "lightslateblue" :weight semi-bold))))
 ...
 '(font-lock-string-face ((t (:bold t :background "black" :foreground "lightslateblue" :weight semi-bold))))
 ...
 '(minibuffer-prompt ((t (:background "black" :foreground "lightslateblue"))))
 ...
 '(tabbar-unselected-face ((t (:background "black" :foreground "lightslateblue"))))
