...
(let ((blck "#000000")
  ...
  (custom-theme-set-faces
   ...
   `(paren-mismatch-face ((t (:foreground ,wht :background ,prpl :strike-through t))))
   ...
   `(erc-pal-face ((t (:bold t :foreground ,prpl :weight bold))))
   ...
   `(font-lock-preprocessor-face ((t (:foreground ,prpl))))
   ...
   `(gnus-server-agent-face ((t (:bold t :foreground ,prpl :weight bold))))
   ...
   `(header-line ((t (nil))))
   `(highlight ((t (:foreground ,blck :background ,prpl))))
   `(ido-first-match-face ((t (:bold t :weight bold))))
   `(ido-indicator-face ((t (:background ,prpl :foreground ,wht :width condensed))))
   ...
   `(region ((t (:background ,prpl :foreground ,wht))))
   `(scroll-bar ((t (nil))))
