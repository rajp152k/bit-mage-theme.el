...
(custom-theme-set-faces
 ...
 '(paren-mismatch-face ((t (:foreground "#FFFFFF" :background "#A020F0" :strike-through t))))
 ...
 '(erc-pal-face ((t (:bold t :foreground "#A020F0" :weight bold))))
 ...
 '(font-lock-preprocessor-face ((t (:foreground "#A020F0"))))
 ...
 '(gnus-server-agent-face ((t (:bold t :foreground "#A020F0" :weight bold))))
 ...
 '(header-line ((t (nil))))
 '(highlight ((t (:foreground "#000000" :background "#A020F0"))))
 '(ido-first-match-face ((t (:bold t :weight bold))))
 '(ido-indicator-face ((t (:background "#A020F0" :foreground "#FFFFFF" :width condensed))))
 ...
 '(mode-line ((t (:bold t :background "#404040" :foreground "green" :weight semi-bold :box (:line-width -1 :color "#606060")))))
 ...
 '(region ((t (:background "#A020F0" :foreground "#FFFFFF"))))
 '(scroll-bar ((t (nil))))
